...
> `ifelse(frac_start == 8 & ((w_end - w_start) == 1),1,frac_start)` Maintain `frac_start` to get estimate output similar to `w_between`

> `w_start = ifelse((w_end - w_start) > 1, w_start + 1, w_start)`
